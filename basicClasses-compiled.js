...
var QualityContainer = function () {
    ...
    _createClass(QualityContainer, [{
        ...
        value: function getQualityWithName(name) {
            ...
            try {
                for (var _iterator4 = this.qualities[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                    var q = _step4.value;
...
var Player = function (_QualityContainer2) {
    ...
    _createClass(Player, [{
        ...
        value: function getOptions() {
            ...
            try {
                for (var _iterator5 = this.location.traders[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
        ...
        value: function removeItemStack(stack) {
            ...
            try {
                for (var _iterator8 = this.itemStacks[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                    var s = _step8.value;
...
var Trader = function (_QualityContainer3) {
    ...
    _createClass(Trader, [{
        ...
        value: function isVisible() {
            ...
            try {
                for (var _iterator9 = this.requirements[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                    var require = _step9.value;
